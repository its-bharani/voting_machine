...
set_property IOSTANDARD LVCMOS18 [get_ports p4]
set_property IOSTANDARD LVCMOS18 [get_ports p3]
set_property IOSTANDARD LVCMOS18 [get_ports p2]
set_property IOSTANDARD LVCMOS18 [get_ports clock]
set_property IOSTANDARD LVCMOS18 [get_ports on_off]
set_property IOSTANDARD LVCMOS18 [get_ports p1]
set_property PACKAGE_PIN E3 [get_ports clock]
set_property PACKAGE_PIN J15 [get_ports on_off]
set_property PACKAGE_PIN P18 [get_ports p1]
set_property PACKAGE_PIN P17 [get_ports p2]
set_property PACKAGE_PIN M18 [get_ports p3]
set_property PACKAGE_PIN M17 [get_ports p4]
set_property PACKAGE_PIN U11 [get_ports s1]
set_property PACKAGE_PIN V10 [get_ports s2]
set_property PACKAGE_PIN L16 [get_ports win]
